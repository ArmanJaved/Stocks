...
public class ConsolidationRecycleradapter extends RecyclerView.Adapter<ConsolidationRecycleradapter.MyViewHolder> {
    ...
    public ConsolidationRecycleradapter(Activity applicationContext, List<String> moviesList) {
