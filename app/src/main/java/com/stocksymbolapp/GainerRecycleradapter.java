...
public class GainerRecycleradapter extends RecyclerView.Adapter<GainerRecycleradapter.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View view) {
            ...
            lineChart = (LineChart)view.findViewById(R.id.asdlinechart);
    ...
    public GainerRecycleradapter(Activity applicationContext, List<String> moviesList) {
...
//                        Toast.makeText(getApplicationContext(), error.toString(), Toast.LENGTH_LONG).show();
        ...
        if (chartstatus.equals("c")) {
            ...
            holder.candleStickChart.setVisibility(View.VISIBLE);
            holder.lineChart.setVisibility(View.GONE);
        }
        else{

            holder.lineChart.setVisibility(View.VISIBLE);
            holder.candleStickChart.setVisibility(View.GONE);
        }
...
//                                    percentageSymbol = String.valueOf(total_per);
                                ...
                                holder.lineChart.setNoDataText("You need to provide data for the chart.");
                                ...
                                holder.lineChart.setData(lidata);
                                holder.lineChart.invalidate();
