...
public class MultipleBottomRecycleradapter extends RecyclerView.Adapter<MultipleBottomRecycleradapter.MyViewHolder> {
    ...
    public MultipleBottomRecycleradapter(Activity applicationContext, List<String> moviesList) {
