...
public class MultipleTopRecycleradapter extends RecyclerView.Adapter<MultipleTopRecycleradapter.MyViewHolder> {
    ...
    public MultipleTopRecycleradapter(Activity applicationContext, List<String> moviesList) {
