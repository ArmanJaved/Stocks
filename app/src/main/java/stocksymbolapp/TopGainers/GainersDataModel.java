...
public class GainersDataModel {
    ...
    public GainersDataModel(String asp_name, String mentions, String positive, String negative, String netural, String status, String asp_rate) {
